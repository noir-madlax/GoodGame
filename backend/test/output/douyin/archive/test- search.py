...
def request_search_once(api_key: str, keyword: str) -> dict:
	"""Call the general search V3 API once and return JSON response.

	Try several common TikHub base URLs to maximize compatibility.
	"""
	headers = {
	...
	for base in base_urls:
		url = f"{base}/api/v1/douyin/search/fetch_general_search_v3"
		try:
...
def main() -> None:
	...
	outfile = output_dir / f"douyin_search_v3_{stamp}.json"
