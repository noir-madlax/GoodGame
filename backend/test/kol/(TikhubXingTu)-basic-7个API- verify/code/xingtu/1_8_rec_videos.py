"""
接口 1.8: 获取KOL推荐视频 (Recommended Videos)

功能: 获取KOL的推荐视频列表，用于展示代表作品
...
def get_kol_rec_videos(api_key: str, kol_id: str, cookie: str):
    """
    调用推荐视频接口
    ...
    endpoint = "/douyin/xingtu/kol_rec_videos_v1"
...
def main():
    """主函数"""
    interface_name = 'rec_videos'
    
    print('='*70)
    print('接口 1.8: 获取KOL推荐视频')
    print('='*70)
    ...
    # 5. 逐个处理KOL
    print(f'\n4️⃣ 开始获取推荐视频...')
    print(f'  参数: kolId + count=10 + cursor=0')
    print('='*70)
    ...
    for idx, kol in enumerate(pending_kols, 1):
        ...
        # 调用接口
        result = get_kol_rec_videos(api_key, kol['xingtu_kol_id'], cookie)
