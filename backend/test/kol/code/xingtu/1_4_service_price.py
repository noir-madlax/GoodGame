...
功能: 获取KOL的服务报价数据，包括视频、直播、图文报价、历史订单数等
...
def get_kol_service_price(api_key: str, kol_id: str, cookie: str):
    """
    调用服务报价接口
    ...
    # 正确参数: kolId（驼峰） + platformChannel=_1（短视频）
    params = {
        'kolId': kol_id,
        'platformChannel': '_1'  # _1=短视频, _10=直播（但_10会返回400）
    }
...
def main():
    """主函数"""
    interface_name = 'service_price'
    
    print('='*70)
    print('接口 1.4: 获取KOL服务报价')
    print('='*70)
    ...
    # 5. 逐个处理KOL
    print(f'\n4️⃣ 开始获取服务报价数据...')
    print(f'  参数: kolId + platformChannel=_1 (短视频)')
    print('='*70)
    ...
    for idx, kol in enumerate(pending_kols, 1):
        ...
        # 调用接口
        result = get_kol_service_price(api_key, kol['xingtu_kol_id'], cookie)
