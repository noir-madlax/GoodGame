"""
接口 1.3: 获取KOL受众画像 ✅ (已验证可用)

功能: 获取KOL的受众画像数据，包括性别、年龄、地域、兴趣标签等
...
def get_kol_audience_portrait(api_key: str, kol_id: str, cookie: str):
    """
    调用受众画像接口
...
def main():
    """主函数"""
    interface_name = 'audience_portrait'
    
    print('='*70)
    print('接口 1.3: 获取KOL受众画像')
    print('='*70)
    ...
    for idx, kol in enumerate(pending_kols, 1):
        ...
        # 调用接口
        result = get_kol_audience_portrait(api_key, kol['xingtu_kol_id'], cookie)
