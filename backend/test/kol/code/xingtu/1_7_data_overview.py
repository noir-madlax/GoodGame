"""
接口 1.7: 获取KOL数据概览 (Data Overview)

功能: 获取KOL的数据概览，包括流量数据、互动数据、转化数据等
...
def get_kol_data_overview(api_key: str, kol_id: str, cookie: str):
    """
    调用数据概览接口
    ...
    endpoint = "/douyin/xingtu/kol_data_overview_v1"
    ...
    # 参数: kolId + _type=_1(个人视频) + _range=_2(30天) + flowType=1
    params = {
        'kolId': kol_id,
        '_type': '_1',      # _1=个人视频, _2=星图视频
        '_range': '_2',     # _2=30天, _3=90天
        'flowType': 1       # 流量类型，默认1
    }
...
def main():
    """主函数"""
    interface_name = 'data_overview'
    
    print('='*70)
    print('接口 1.7: 获取KOL数据概览')
    print('='*70)
    ...
    # 5. 逐个处理KOL
    print(f'\n4️⃣ 开始获取数据概览...')
    print(f'  参数: kolId + _type=_1(个人视频) + _range=_2(30天) + flowType=1')
    print('='*70)
    ...
    for idx, kol in enumerate(pending_kols, 1):
        ...
        # 调用接口
        result = get_kol_data_overview(api_key, kol['xingtu_kol_id'], cookie)
