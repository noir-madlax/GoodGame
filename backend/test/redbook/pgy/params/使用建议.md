...
| 接口 | 状态 | 说明 |
|------|------|------|
| `get-kol-track/v1` | ❌ 404 | **已下线**，所有参数组合都返回 404 |
| `get-kol-cost-effective/v1` | ✅ 可用 | 之前 301 是偶发问题，重试后成功 |
| `get-note-detail/v1` | ❌ 301 | **已废弃**，使用 `note_detail_solar` 替代 |
| `get-kol-note-list/v1` | ⚠️ 限制 | 仅对**蒲公英注册博主**有效 |
| `notes_detail_v2` | ⚠️ 限制 | 仅对**蒲公英注册博主**有效 |
